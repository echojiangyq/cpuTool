...
public final class BLListAlert {
	...
	public static Dialog showAlert(Context context, String title, String[] items, final OnAlertSelectId alertDo) {
...
class AlertAdapter extends BaseAdapter {
	...
	public AlertAdapter(Context context, String title, String[] items, String exit) {
		if (items == null || items.length == 0) {
			...
			this.items = CommonUnit.stringsToList(items);
		}
